...
/* package tradutor-0.1.0.0 */
#ifndef VERSION_tradutor
#define VERSION_tradutor "0.1.0.0"
#endif /* VERSION_tradutor */
#ifndef MIN_VERSION_tradutor
#define MIN_VERSION_tradutor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tradutor */
...
#define CURRENT_COMPONENT_ID "tradutor-0.1.0.0-6zFAM2vkDQUFFe5y3ow5qk-tradutor"
