...
/* package primeiro-projeto-0.1.0.0 */
#ifndef VERSION_primeiro_projeto
#define VERSION_primeiro_projeto "0.1.0.0"
#endif /* VERSION_primeiro_projeto */
#ifndef MIN_VERSION_primeiro_projeto
#define MIN_VERSION_primeiro_projeto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_primeiro_projeto */
...
#define CURRENT_COMPONENT_ID "primeiro-projeto-0.1.0.0-HgPq5y8Utmk4yTJGlMMNa-primeiro-projeto"
