...
/* package Fliperama-0.1.0.0 */
#ifndef VERSION_Fliperama
#define VERSION_Fliperama "0.1.0.0"
#endif /* VERSION_Fliperama */
#ifndef MIN_VERSION_Fliperama
#define MIN_VERSION_Fliperama(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Fliperama */
...
#define CURRENT_COMPONENT_ID "Fliperama-0.1.0.0-DMjpEMZafoBJieASwNJzrO-fliperama-test"
